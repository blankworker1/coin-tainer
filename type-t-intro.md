...
*Technical intro to the three working HTML tools. For Type T's product specification, physical construction, and build-priority status, see `type-t.md`. For material shared with Type L, see `protocol-shared.md`.*
